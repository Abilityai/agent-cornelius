...
- **LinkedIn posts:** Use `[User]_LinkedIn_Tone_of_Voice_Profile.md`
- **Twitter/X posts:** Use `[User]_Twitter_Tone_of_Voice_Profile.md`
- **Threads/Instagram text posts:** Use `[User]_Text_Post_Tone_of_Voice_Profile.md`

**Location:** `$TONE_PROFILES_PATH/`
...
1. **Vault Manager Agent** (`vault-manager`)
   ...
   - **File format**: `CHANGELOG - [Session Type] YYYY-MM-DD.md` in `./Brain/05-Meta/Changelogs/`
...
3. **Auto-Discovery Agent** (`auto-discovery`)
   ...
   - **MANDATORY: Creates separate dated changelog file** in `./Brain/Changelogs/`
...
4. **Insight Extractor Agent** (`insight-extractor`)
   ...
   - **Storage location**: All AI-extracted permanent notes saved to `./Brain/AI Extracted Notes/`
...
5. **Document Insight Extractor Agent** (`document-insight-extractor`)
   ...
   - **Storage location**: Session-based folders in `./Brain/Document Insights/[session-folder]/`
...
**Ruby's Location**: `$RUBY_AGENT_PATH/`
...
- **If user asks about content posting**: Inform them to use Ruby agent at `$RUBY_AGENT_PATH/`
...
- **Clear attribution:** Video descriptions state: "This content is autonomously generated and curated by Cornelius, [User]'s AI insight harvester. These are synthesized perspectives from [User]'s knowledge base, structured and presented by the agent."
...
Location: `./Brain/06-Belief-System/`
